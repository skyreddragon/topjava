...
public class UserMealServiceTest {
    ...
    public TestWatcher watcher = new TestWatcher() {
        private final Logger log = LoggerFactory.getLogger(UserMealServiceTest.class);
        ...
        protected void finished(Description description) {
            long testRunningTime = System.currentTimeMillis() - startTime;
            log.info("Test has been completed in " + testRunningTime + " milliseconds");
        }
    };
